...
#	ref=$(git symbolic-ref HEAD 2> /dev/null) || return echo "$(parse_git_dirty)$ZSH_THEME_GIT_PROMPT_PREFIX$(current_branch)$ZSH_THEME_GIT_PROMPT_SUFFIX" 
#}
...
#echo $(( ${COLUMNS} - 3 - ${#HOST} - ${#$(get_pwd)} ))

#local termwidth 
#local termwidth (( termwidth = ${COLUMNS} - 3 - ${#HOST} - ${#$(get_pwd)} ))
#- ${bat} - ${git} ))
...
# The following code originally from jonathan zsh theme
# customized somewhat
